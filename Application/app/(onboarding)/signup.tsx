      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.main}>
          ...
          <View style={styles.segmented}>
            <TouchableOpacity style={styles.segment} onPress={() => router.push('/(onboarding)/login' as any)}>
              <Text style={styles.segmentText}>Connexion</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.segment, styles.segmentActive]}>
              <Text style={[styles.segmentText, styles.segmentTextActive]}>Créer un compte</Text>
            </TouchableOpacity>
          </View>
          ...
          <TouchableOpacity style={styles.primaryButton} onPress={() => router.push('/(onboarding)/reason' as any)}>
